...
from cogs.statusmodal import StatusUpdateModal  # , get_status_data, statusbanner
...
@muwubot.tree.command(name="update_status", description="update your bio and status")
